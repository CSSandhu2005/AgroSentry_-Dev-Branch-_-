...
Return JSON:
{
  ...
  if (farmerId) {
    ...
    const rows = await dbExecute(
      'INSERT INTO crop_plans (farmer_id, crop_name, sowing_schedule, irrigation_plan, fertilizer_schedule, pest_alerts, harvest_timeline) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING plan_id',
    ...
    const planId = rows[0]?.plan_id as number;
    plan.plan_id = planId;
