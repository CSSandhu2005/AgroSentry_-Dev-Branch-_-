...
export const FARM_TOOLS = [
  {
    ...
    function: {
      ...
      description: "Get the current farmer's complete profile: name, village/district/state, land size, irrigation, soil type, and primary crops. Call this first in most conversations to personalize the response.",
  ...
  },
  {
    ...
    function: {
      ...
      description: 'Get AI-powered crop recommendations based on soil type, irrigation availability, season, and primary crop goals. Call this when the farmer asks what to plant.',
      parameters: {
        type: 'object',
        properties: {
          soil_type: {
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          land_acres: {
            type: 'number',
            description: 'Size of the land in acres. If not provided, the tool will attempt to use the land acres from the farmer profile.',
          },
        },
        required: [],
      },
