  ...
  return (
    <section className="h-screen w-full">
      <div className="relative h-full w-full overflow-hidden rounded-2xl md:rounded-[2rem]">
        ...
        {/* Hero content */}
        <div className="absolute bottom-8 left-0 right-0 px-4 pb-2 sm:px-6 md:px-10">
          <div className="grid grid-cols-12 items-end gap-4">
            
            <div className="col-span-12 lg:col-span-8">
              <h1
                className="font-medium leading-[0.85] tracking-[-0.01em] text-[7vw]"
                style={{ color: "#E1E0CC" }}
              >
                <WordsPullUp text="AgroSentry Autonomous Drone" showAsterisk />
              </h1>
            </div>
{/* 
